export const dictionary = {
    en: {
        app_title: "GRIHA-MITRA", companion: "Companion", global_lang: "GLOBAL LANGUAGE",
        nav_home: "HOME", nav_appliance: "APPLIANCE", nav_translator: "TALK", nav_ledger: "LEDGER",
        appliance_desc: "Models & Repairs", translator_desc: "Voice Walkie-Talkie", ledger_desc: "Track Work & Earnings",
        appliance_ai_title: "Identify Issue via AI:", btn_take_picture: "TAKE PICTURE OF ERROR", gemini_loading: "Gemini AI Analyzing...",
        gemini_diagnosis_label: "GEMINI DIAGNOSIS:", manual_search_title: "MANUAL SEARCH", manual_search_model: "LG REFRIGERATOR",
    ...
    hi: {
        ...
        nav_home: "मुख्य पृष्ठ", nav_appliance: "उपकरण", nav_translator: "बात करें", nav_ledger: "खाता",
        appliance_desc: "मॉडल और मरम्मत", translator_desc: "वॉयस वॉकी-टॉकी", ledger_desc: "काम और कमाई ट्रैक करें",
        appliance_ai_title: "AI द्वारा समस्या पहचानें:", btn_take_picture: "तस्वीर लें", gemini_loading: "जेमिनी एआई विश्लेषण कर रहा है...",
        gemini_diagnosis_label: "AI निदान:", manual_search_title: "मैनुअल खोज", manual_search_model: "एलजी रेफ्रिजरेटर",
    ...
    bn: {
        ...
        nav_home: "হোম", nav_appliance: "যন্ত্রপাতি", nav_translator: "কথা বলুন", nav_ledger: "খাতা",
        appliance_desc: "মডেল এবং মেরামত", translator_desc: "ভয়েস ওয়াকি-টকি", ledger_desc: "কাজ এবং উপার্জন ট্র্যাক করুন",
        appliance_ai_title: "AI দ্বারা সমস্যা চিহ্নিত করুন:", btn_take_picture: "ত্রুটির ছবি তুলুন", gemini_loading: "জেমিনি এআই বিশ্লেষণ করছে...",
        gemini_diagnosis_label: "জেমিনি ডায়াগনসিস:", manual_search_title: "ম্যানুয়াল অনুসন্ধান", manual_search_model: "এলজি রেফ্রিজারেটর",
    ...
    te: {
        ...
        nav_home: "హోమ్", nav_appliance: "ఉపకరణం", nav_translator: "మాట్లాడండి", nav_ledger: "లెడ్జర్",
        appliance_desc: "నమూనాలు, మరమ్మతులు", translator_desc: "వాయిస్ వాకీ-టాకీ", ledger_desc: "పనిని ట్రాక్ చేయండి",
        appliance_ai_title: "AI ద్వారా సమస్యను గుర్తించండి:", btn_take_picture: "లోపం యొక్క చిత్రాన్ని తీయండి", gemini_loading: "AI విశ్లేషిస్తోంది...",
        gemini_diagnosis_label: "రోగ నిర్ధారణ:", manual_search_title: "మాన్యువల్ శోధన", manual_search_model: "ఎల్జీ రిఫ్రిజిరేటర్",
    ...
    kn: {
        ...
        nav_home: "ಮನೆ", nav_appliance: "ಉಪಕರಣ", nav_translator: "ಮಾತನಾಡಿ", nav_ledger: "ಲೆಡ್ಜರ್",
        appliance_desc: "ಮಾದರಿಗಳು, ರಿಪೇರಿ", translator_desc: "ಧ್ವನಿ ವಾಕಿ-ಟಾಕಿ", ledger_desc: "ಕೆಲಸ ಟ್ರ್ಯಾಕ್ ಮಾಡಿ",
        appliance_ai_title: "AI ಮೂಲಕ ಸಮಸ್ಯೆ ಗುರುತಿಸಿ:", btn_take_picture: "ಚಿತ್ರವನ್ನು ತೆಗೆದುಕೊಳ್ಳಿ", gemini_loading: "AI ವಿಶ್ಲೇಷಿಸುತ್ತಿದೆ...",
        gemini_diagnosis_label: "ರೋಗನಿರ್ಣಯ:", manual_search_title: "ಹುಡುಕಾಟ", manual_search_model: "ಎಲ್ಜಿ ರೆಫ್ರಿಜರೇಟರ್",
    ...
    ta: {
        ...
        nav_home: "முகப்பு", nav_appliance: "சாதனம்", nav_translator: "பேசு", nav_ledger: "கணக்கு",
        appliance_desc: "மாதிரிகள் & பழுதுகள்", translator_desc: "குரல் வாக்கி-டாக்கி", ledger_desc: "வேலை & வருவாயை கண்காணிக்க",
        appliance_ai_title: "AI மூலம் சிக்கலை கண்டறியவும்:", btn_take_picture: "பிழையை படம் எடுக்கவும்", gemini_loading: "Gemini AI பகுப்பாய்வு செய்கிறது...",
        gemini_diagnosis_label: "ஜெமினி நோயறிதல்:", manual_search_title: "கைமுறை தேடல்", manual_search_model: "LG குளிர்சாதனப் பெட்டி",
    ...
    ml: {
        ...
        nav_home: "ഹോം", nav_appliance: "ഉപകരണം", nav_translator: "സംസാരിക്കുക", nav_ledger: "ലെഡ്ജർ",
        appliance_desc: "മോഡലുകളും അറ്റകുറ്റപ്പണികളും", translator_desc: "വോയ്‌സ് വാക്കി-ടോക്കി", ledger_desc: "ജോലിയും വരുമാനവും ട്രാക്ക് ചെയ്യുക",
        appliance_ai_title: "AI വഴി പ്രശ്നം കണ്ടെത്തുക:", btn_take_picture: "പിശകിന്റെ ചിത്രം എടുക്കുക", gemini_loading: "Gemini AI വിശകലനം ചെയ്യുന്നു...",
        gemini_diagnosis_label: "ജെമിനി ഡയഗ്നോസിസ്:", manual_search_title: "മാനുവൽ തിരയൽ", manual_search_model: "എൽജി റഫ്രിജറേറ്റർ",
...
export const languageMap = { 'en': 'English', 'hi': 'Hindi', 'bn': 'Bengali', 'te': 'Telugu', 'kn': 'Kannada', 'ta': 'Tamil', 'ml': 'Malayalam' };